...
int isAsciiDigit(int x) {
    int result = !(0x3 ^ (x>>4));
    x = x & 0x0f;
    int result2 =  result &  (!(x & 0x08) | ( !(x & 0x06)) ) ; //first is zero
   return result;
}
/* 
 ...
 *   Rating: 3
 */
//  flag == 0; flag_x = 0 , 0 return 0
//  flag == 0; flag_x = 0 , 1 return 1
//  flag == 0; flag_x = 1 , 0 return 0
//  flag == 0; flag_x = 1 , 1 return 1
//  flag == 1; flag_x = 0 , 0 return 0
//  flag == 1; flag_x = 0 , 1 return 0
//  flag == 1; flag_x = 1 , 0 return 1
//  flag == 1; flag_x = 1 , 1 return 1
int isLessOrEqual(int x, int y) {
    int flag_x = !!(x & 0x80000000);
    int flag = !!((x & 0x80000000) ^ (y & 0x80000000)) ;
    x = (x & 0x7fffffff) + ~((y & 0x7fffffff) + 0xffffffff) ;
    x = !!(x & 0x80000000);
    return   (flag & flag_x) | (~flag & x);
}
